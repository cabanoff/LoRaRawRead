...
void usage(void)
{
	...
	printf(" -n         <uint>  transmitter numbers are entered comma-separated 1,2,3,4,5,6,7,8]n");
...
int main(int argc, char **argv)
{
	...
	uint32_t f_target = 869120000U; /* transmitter frequency */
	...
	while ((i = getopt (argc, argv, "hetdcn:")) != -1)
	{
		char *p_ch;
		switch (i)
		{
	...
	for (i = 0; i < LGW_MULTI_NB; ++i)
	{
		...
		if (true)
		{
			...
			case 2:
				...
				break;
			case 3:
				ifconf.freq_hz = 140000;
				break;
			case 4:
				ifconf.freq_hz = 280000;
				break;
			case 5:
				ifconf.freq_hz = 320000;
				break;
			case 6:
				ifconf.freq_hz = 350000;
				break;
			case 7:
				ifconf.freq_hz = 400000;
				break;
